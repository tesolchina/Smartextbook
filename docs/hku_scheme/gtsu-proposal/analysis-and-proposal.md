...
MartinPeaceBot works through a specific mechanism: *distilling teacher expertise into AI-delivered scaffolding across all three skill areas simultaneously.* The teacher's knowledge of what rigorous diplomatic research looks like, what a coherent position paper requires, and what persuasive oral delivery demands — expertise that cannot be delivered to every team individually — was encoded in Spring 2026 into four AI tutors. Each tutor delivers that expertise as a personalised, iterative dialogue. The student team remains the decision-maker: which country interests are most salient, which arguments to prioritise, which rhetorical choices to make. The AI asks what the teacher would ask if they had unlimited time with every team.

This RSLEIHE project asks the question the Spring 2026 pilot cannot answer alone: *when students who experienced this distillation process redesign it based on what they learned, does the next cohort learn more deeply?* A 2025 randomised controlled trial found that proactive AI scaffolding significantly enhances comprehension compared to passive tools (Kwan et al., 2025). This project tests whether student-led refinement of the distillation adds a further layer of improvement — and produces a documented, open-source tutor framework any institution can adopt with any AI provider.
